...
To use these stylesheets, rename the files and afrojped with the name of your theme.
...
afrojped-alpha-default-narrow.css  
...
afrojped-alpha-default-normal.css
...
afrojped-alpha-default-wide.css
